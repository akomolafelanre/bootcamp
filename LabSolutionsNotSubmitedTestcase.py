import unittest, LabSolutionsNotSubmitted
...
class ListComprehensionTest(unittest.TestCase):
    ...
    def setUp(self):
        self.one_to_twenty = LabSolutionsNotSubmitted.BinarySearch(20, 1)
        self.two_to_forty = LabSolutionsNotSubmitted.BinarySearch(20, 2)
        self.ten_to_thousand = LabSolutionsNotSubmitted.BinarySearch(100, 10)
...
class BinarySearchTest(unittest.TestCase):
    ...
    def test_medium_list_search(self):
        ...
        self.assertEqual(
            self.two_to_forty.length,
            search3['count'],
            msg='should return {count: list_length, index: -1} for 33'
        )
        self.assertEqual(
            -1,
            search3['index'],
    ...
    def test_large_list_search(self):
        ...
        self.assertEqual(
            self.ten_to_thousand.length,
            search3['count'],
            msg='should return {count: list_length, index: -1} for 10000'
        )
        self.assertEqual(
            -1,
            search3['index'],
